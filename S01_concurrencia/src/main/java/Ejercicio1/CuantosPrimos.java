...
public class CuantosPrimos {
    public static void main(String[] args) {
        ...
        try { //esperamos a que terminen todos
            p1.join(); p2.join(); p3.join(); p4.join(); p5.join(); 
        } catch (InterruptedException e) {}
        
        int n = p1.cuantos() + p2.cuantos() + p3.cuantos()
                + p4.cuantos() + p5.cuantos();
        
        long t1 = (new Date()).getTime();
           System.out.println("Numero de primos menores que 10.000.000: " + n
